...
If you are not certain with you status, review [Determine Rsearchers Status](../determine-status.qmd).
:::
...
::: answer
A: Review [determine status](determine-status.qmd).
...
::: callout
Check [Frequently Asked Questions](faq.qmd) for more possibly related questions.
