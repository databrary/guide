...
The defaults in Handbrake are the same that as the .mp4 codec that Databrary uses.

- H.264 (x264) PFR video
- AAC, 2ch Stereo audio (force to 2ch mixdown)
- Choose the option for "passthru" metadata
