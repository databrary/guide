...
The **Manage Access** tab allows you to choose volume sharing options and add collaborators (faculty, staff, students) who already have an account on Databrary and their account is sponsored by an Institution or an Authorized Investigator.
...
=======
Please be sure to pick the appropriate sharing setting for your volume between the following options: Private, Share Volume Overview Only or Share Entire Volume. The default sharing setting when you create a new volume is is Private.
>>>>>>> Stashed changes
...
Please note: Only the Authorized Investigator who created this volume can select the 'Share Entire Volume' option.
...
<<<<<<< Updated upstream
You may choose to add collaborating researchers who are registered on Databrary to your Databrary volume. All collaborators that you add will appear in the citation generated for this volume.

Adding collaborators is the next section on this tab. Here, you are the ability to add any faculty, students, or staff who are working with you on the project associated with the Databrary volume. 

Search for your collaborator through the search function (see image below). You may search for an individual through the name or the email address affiliated with their Databrary account. Once you have selected their name, you will see several permission levels that you may grant them as a colloborator to your volume: **Read only**, **Read/write**, **Investigator (Read/write/share)**. You also have the ability to grant access to your collaborator's own affiliates (students, research staff, or post-doctoral researchers who have been granted access by your affiliate to access data on Databrary). 

**Read only**: This allows the individual to access and download any data in your volume.

**Read/write**:This allows the same permissions as the level below below, as well as the ability to upload, edit, and delete any data as well.

**Investigator (Read/write/share)**: This allows the same permissions as the level below, as well as the ability to add new collaborators to the volume. As a general rule of thumb, you should add any co-investigators on the grant to this volume and give them this level of permission.
=======
Adding collaborators is the next section on this tab. Here, you are the ability to add any faculty, students, or staff who are working with you on the project associated with the Databrary volume. 
>>>>>>> Stashed changes

There are 3 levels of permission you can grant a collaborator: Read only, Read/write, and Investigator (Read/write/share).
...
In addition to granting an individual "Investigator" status on your volume, you can choose to extend access to their affiliates.
