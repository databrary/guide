...
To search for a specific volume, click on the stacked-bar icon to the right of the "Name" in the volume table. This will bring up a search window that you can use to find or filter volumes.
...
To expand/condense the number of volume entries shown in the table, click on the number to the right of the "Page Size" label at the bottom of the volume table.
...
To simplify the migration to Databrary 2.0, we selected a single volume owner model as previously there could be multiple owners (Investigators).
...
![Editing details about an Affiliate's access.](include/img/edit-affiliate-details.png){#fig-editing-affiliate}
...
4. Scroll down to the Reorder Citation section. Click on the author you wish to reposition. 
