...
![Citations](img/db-edit-citations)
...
![Check the Citation](img/db-check-citation.png)
...
![Add Alternative Citation in Descriptions](img/db-add-alternative-reference.png)
...
![Create Highlight for study](img/db-create-highlights.png)
