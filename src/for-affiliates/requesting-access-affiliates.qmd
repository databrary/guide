...
Ensuring that data is used appropriately is a core principle of Databray.
Users will be **required** to register an account and obtain authorization to gain further access.
