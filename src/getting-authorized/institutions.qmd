# Institutions {.unnumbered #sec-getting-started-institutions}
...
An official signature by an Authorized Organizational Representative (AOR) on the DAA constitutes formal institional approval.
...
Consistent with institutional policies, these individuals may be granted access to Databrary as a *Sponsored Researcher* of a supervising Authorized Investigator.

## Seeking Authorization {-}

In most cases, a faculty researcher initiates a request for authorization when they [register](https://databrary.org/user/register) for access and create an account on Databrary.
...
Most institutions require the researcher to sign and/or initial the documents, alongside signatures from the AOR.
