...
*You are only seeing volumes that are private from other researchers. If you want to reuse data, find shared volumes. Explain users and institutions search page more. Don't need to differentiate between search and find clips page. Search queries are ordered off of relevance. Break down components of page more. Include calloutbox of DB search only returning volumes and we are planning to search for specific files and sessions*
