...
Since access to restricted materials on Databrary requires formal *authorization* from an institution, the first step for every user is to register, create an account, and request authorization.
