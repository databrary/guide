...
`race` As classified by NIH, or user-defined classification
  - American Indian or Alaska Native, Asian, Black or African American, Native Hawaiian or Other Pacific Islander, White, Unknown or not reported, Refused

`ethnicity` As classified by NIH (Hispanic/Non-Hispanic), or user-defined classification
  - Hispanic or Latino, Not Hispanic or Latino, Unknown or not reported, Refused
