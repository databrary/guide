...
The *Authorized Investigator* determines what access an *Affiliate* has to 1. Other researcher's (shared) data on Databrary and 2. the Authorized Investigator's (shared and private) data.
