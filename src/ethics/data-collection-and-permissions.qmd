# Ethics for Data Contribution {.unnumbered}

## Setting up IRB Protocol

This [document](https://databrary.org/support/irb/irb-application) is intended to help researchers who plan to store and share video data in Databrary prepare IRB materials for approval.

Researchers should confirm institution, agency, directorate, or program-specific application requirements before submission.

Please contact us at [contact@databrary.org](contact@databrary.org) for further assistance.

## Obtaining Permissions 

You must obtain participant's permission to share their data on Databrary. It is best practice to have a data release form as well as a standardized script when requesting participant's permission to share their data on Databrary.
...
## Sharing Data Collected Without a Databrary-Specific Release {.unnumbered}
...
### Seek Formal Permission From Your IRB {.unnumbered}
...
### Share Data with Databrary {.unnumbered}

You may [create a new volume](../contributing-data/start.qmd) yourself or contact Databrary for help in doing so.
