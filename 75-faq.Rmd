...
The defaults in Handbrake are the same that as the .mp4 codec that Databrary uses during the transcoding process after a video file is uploaded. Recommended settings are below.
